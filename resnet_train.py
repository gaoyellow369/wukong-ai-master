        ...
        with open(csv_file, 'r') as file:
            ...
            for i, row in enumerate(csv_reader):
                ...
                if os.path.exists(image_filename):  
                    ...
                    print(f"图像文件 {image_filename} 不存在，跳过此行")
...
train_accuracy_0, train_accuracy_1 = evaluate(train_loader)
print(f"训练集上标签为0的样本准确率: {train_accuracy_0:.2f}%")
print(f"训练集上标签为1的样本准确率: {train_accuracy_1:.2f}%")

test_accuracy_0, test_accuracy_1 = evaluate(test_loader)
print(f"测试集上标签为0的样本准确率: {test_accuracy_0:.2f}%")
print(f"测试集上标签为1的样本准确率: {test_accuracy_1:.2f}%")
